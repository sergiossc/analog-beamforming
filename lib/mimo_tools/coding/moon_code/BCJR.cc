...
BCJR::BCJR(BinConv &encoder, int in_L,double in_sigma2)
{
   L = in_L;
   sigma2 = in_sigma2;
   Q = (1<<encoder.nu);
...
// 
// (This could be simplified more, but is left in this form to
// explicitly show the nature of the computations)
{
...
//
// (Again, this could be simplified more...)
{
   double *a;					// output selection
   int j;
...
// Build the previous state information and the inputfrom information
// and the S data
{
