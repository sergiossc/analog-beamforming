...
figure(2); clf;
plot(lattpts1(:,1),lattpts1(:,2),'.');
hold on
plot(lattpts2(:,1),lattpts2(:,2),'o');
plot(lattpts3(:,1),lattpts3(:,2),'x');
plot(lattpts4(:,1),lattpts4(:,2),'+');
...
legend('2\Lambda','2\Lambda+(1,0))','2\Lambda+(1/2,sqrt(3)/2)',...
